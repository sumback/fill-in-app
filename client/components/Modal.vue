...
<template>
  <div v-if="open" class="p-7 flex justify-center fixed left-0 top-0 w-full h-full bg-gray-900 bg-opacity-50 z-50 transition-opacity duration-300 items-start overflow-x-hidden overflow-y-auto" @click="clickOutside">
